...
import OperationalStatus from 'wisdom/pages/OperationalStatus'
import SightseeingBusList from 'wisdom/pages/SightseeingCar/SightseeingBusList/index'
import SightseeingCarDetails from 'wisdom/pages/SightseeingCar/SightseeingBusList/SightseeingCarDetails/index.jsx'
import LineManagment from 'wisdom/pages/SightseeingCar/LineManagement/index'
import TicketManagement from 'wisdom/pages/SightseeingCar/TicketManagement/index'
import DriverList from 'wisdom/pages/SightseeingCar/DriverList/index'
import DriverDetails from 'wisdom/pages/SightseeingCar/DriverList/DriverDetails/index.jsx'

import { name as proName } from 'wisdom/router'
    ...
    children: [
      {
        name: '观光车',
        path: '/SightseeingBus',
        component: SightseeingBusList
      },
      {
        name: '线路',
        path: '/Line',
        component: LineManagment
      },
      {
        name: '司机',
        path: '/Driver',
...
const renderRoutes = (match) => {
  ...
  return (
    <Switch>
      ...
      <Route path = { `${proPath}/Driver/:id` } component = { DriverDetails }></Route>
      <Route path = { `${proPath}/SightseeingBus/:id/:equipId` } component = { SightseeingCarDetails }></Route>
      {/* {ProMenuRoutes({ siderMenus, proPath })} */}
